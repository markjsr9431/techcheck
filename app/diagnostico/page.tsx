...
const OPTIONS = ["PC lenta", "No enciende", "Sin Internet", "Pantalla negra", "Posible virus", "Disco duro", "Pantalla azul", "Otro"] as const;
      ...
      <main>
        <Section>
          <Container className="max-w-2xl">
            ...
            {step === "pantalla-azul" && (
              <PantallaAzulFlow onExitFirstQuestion={() => setStep("pregunta-1")} />
            )}
